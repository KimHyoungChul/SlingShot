...
public class QuickCallContactDetailView extends  QuickCallViewBase{
	...
	public QuickCallContactDetailView(Context context) {
		super(context);
		mContext = context;
		initView();
	}
	
	public QuickCallContactDetailView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		initView();
	}
	...
	public QuickCallContactDetailView(Context context, AttributeSet attrs, int defStyle) {
